...
class Tester {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Maximum activities that can be performed (sample 1): " + findMaxActivities(start1, finish1)); // Output: 4
        System.out.println("Maximum activities that can be performed (sample 2): " + findMaxActivities(start2, finish2)); // Output: 4
    }
}
